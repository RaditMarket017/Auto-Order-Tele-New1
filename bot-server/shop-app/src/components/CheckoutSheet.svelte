    ...
    <div class="w-full max-w-lg bg-[#0c0f1d] border-t sm:border border-indigo-900/40 rounded-t-3xl sm:rounded-2xl p-5 space-y-4 animate-slide-up max-h-[85vh] overflow-y-auto no-scrollbar" onclick={(e) => e.stopPropagation()}>
      ...
      <div class="space-y-2">
        ...
        <div class="grid grid-cols-2 gap-2">
          <button onclick={() => paymentMethod = 'qris'} class="p-3 bg-[#070914] border rounded-xl flex items-center gap-3 text-left transition-all cursor-pointer {paymentMethod === 'qris' ? 'border-violet-500 bg-violet-500/10' : 'border-indigo-900/30 opacity-70'}">
          ...
          <button onclick={() => paymentMethod = 'saldo'} class="p-3 bg-[#070914] border rounded-xl flex items-center gap-3 text-left transition-all cursor-pointer {paymentMethod === 'saldo' ? 'border-violet-500 bg-violet-500/10' : 'border-indigo-900/30 opacity-70'}">
